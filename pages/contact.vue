<template>
  <div v-if="$isAMP" class="text-page container contacts">
    ...
    <div class="contact-item">
      <p>Verdict Membership Questions</p>
    ...
    <div class="contact-item">
      <p>Verdict Technical Problems</p>
          ...
          <div class="col-lg-8">
            <div class="wrapper-terms">
              ...
              <div class="paragraph">
                ...
                <p class="text">For any question related to Verdict Site or App please contact:</p>
                <p class="text">
                  Verdict Support Team -
                  <a class="terms-text-link">support@verdict.org</a>
                </p>
              </div>
              <br />
              <br />
              <div class="paragraph">
                ...
                <p class="text">
                  Verdict Content Team -
                  <a class="terms-text-link">content@verdict.org</a>
                </p>
              </div>
              <br />
              <br />
              <div class="paragraph">
                ...
                <p class="text">For any question related to Verdict development including ideas:</p>
                <p class="text">
                  Verdict Community Team -
                  <a class="terms-text-link">community@verdict.org</a>
                </p>
              </div>
              <br />
              <br />
              ...
              <div class="paragraph">
                ...
                <p class="text">For all other questions please fill out the form below:</p>
              </div>
              <form class="form">
                <div class="input-unit">
                  ...
                  <div>
                    <div v-if="errorNotif && !$v.yourName.required" class="errors">Name is required</div>
                  </div>
                </div>
                <div class="input-unit">
                  ...
                  <div>
                    <div v-if="errorNotif && !$v.email.required" class="errors">Email is required</div>
                    <div
                ...
                <div class="input-unit">
                  ...
                  <div>
                    <div v-if="errorNotif && !reСaptch" class="errors">Press the reСaptch</div>
                  </div>
                </div>
                <button type="submit" @click.prevent="sendEmail" class="signup-btn">Send mail</button>
              </form>
            </div>
          </div>
          <div class="col-lg-4">
