        ...
        <div class="container">
            ...
            <div class="article" v-for="post in data" :key="post.id">
                ...
                <div class="article-author">
                    ...
                    >{{ parse(post.publishedAt, '[on] MMM DD,YYYY HH:mm a ZZ') }}</time>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="policy-wrapper animation">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-8 px-0 px-md-3 pr-lg-5">
                        <div
                            class="d-flex align-items-center px-2 px-sm-3 mt-0 pl-2 pl-md-0 pr-5 pr-md-0 mb-3"
                        >
            ...
            >Unfollow</button>
                        ...
                        <div class="row" v-for="(data, index) in posts" :key="index">
                            <div
                                class="col-12 mb-8 px-0 px-md-3"
...
export default {
    ...
    head() {
        return {
            title:
                this.tag || this.term.name === "news"
                    ? this.term.name + " | Verdict"
                    : "Top stories and discussions on Verdict for " +
                      this.term.name,
        };
    },
    data() {
