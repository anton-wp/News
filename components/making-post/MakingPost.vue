            ...
            <div class="container date">
              <div class="row">
                  ...
                  <div class="schedule-date-col schedule-date" v-if="fields.publishedAt">
                    ...
                    <div class="date-select-wrap">
                      <div class="select-wrap month-select">
                        ...
                        <select class="form-input select" v-model="date.month" @change="saveDraft">
                          <option
                      ...
                      <div class="select-wrap day-select">
                        ...
                        <select class="form-input select" v-model="date.day" @change="saveDraft">
                          <option
                      ...
                      <div class="select-wrap year-select">
                        ...
                        <select class="form-input select" v-model="date.year" @change="saveDraft">
                ...
                <div class="col-sm col-lg-4" style="padding-left: 0px; padding-right: 0px;">
                  <div class="schedule-date-col schedule-time" v-if="fields.publishedAt">
                    <label>Time</label>
                    <div class="time-select-wrap">
                      <div class="select-wrap hours-select">
                        <select class="form-input select" v-model="date.hours" @change="saveDraft">
                          <option
                            v-for="hour of hours"
                            :value="hour"
                            :key="hour"
        ...
        <div class="row mt-4">
          <div class="col-12 col-lg-7 col-xl-8 add-cloumn" v-if="fields.cropper">
            <div class="buttons-wrapp input-wrapper">
              ...
              <button class="button-add post-button" @click.prevent="trigerInputUpload()">Add Image</button>
              <input name="file" type="file" id="file" ref="imgUploadInpt" @change="uploadImg()" />
            </div>
...
export default {
  ...
  methods: {
    ...
    getReservedTimes(id) {
      this.$axios
        .$get(`/api/posts/create-helpers/get-reserved-time?postId=${id}`)
        .then((resp) => {
    ...
    searchOptions(query) {
      if (query) {
        ...
        this.$axios.$get("/api/tags/list?search=" + query).then(({ data }) => {
    ...
    publishedPost() {
      ...
      if (this.$v.$invalid && !this.imgId && !this.selectedLinkOption.length) {
        return;
      }
